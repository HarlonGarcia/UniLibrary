...
const Book = () => {
  ...
  useEffect(() => {
    axios(`${import.meta.env.VITE_APP_GOOGLE_API_URL}/volumes/${id}`).then(
      ({ data }) => {
        setInfo(data);
      }
    );
  ...
  return (
    <div className={styles.book__container}>
      <BookCover
        imageUrl={info.volumeInfo.imageLinks}
